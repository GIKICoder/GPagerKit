...
- (void)setupConfigItems {
    ...
    self.configItems = @[
        [[ConfigItem alloc] initWithTitle:@"ViewScrollPager-Example" action:^{
            GPagerViewExampleController * vc = [GPagerViewExampleController new];
            [weakSelf.navigationController pushViewController:vc animated:YES];
        }],
        [[ConfigItem alloc] initWithTitle:@"ControllerScrollPager-Example" action:^{
            GControllerPagerExampleController * vc = [GControllerPagerExampleController new];
            [weakSelf.navigationController pushViewController:vc animated:YES];
        }],
        [[ConfigItem alloc] initWithTitle:@"PageListController-Example" action:^{
            GPageListExampleViewController * vc = [GPageListExampleViewController new];
            [weakSelf.navigationController pushViewController:vc animated:YES];
        }],
