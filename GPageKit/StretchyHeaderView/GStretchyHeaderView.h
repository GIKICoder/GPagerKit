 ...
 */
typedef NS_ENUM(NSUInteger, GStretchyHeaderViewContentAnchor) {
    /**
     *  The content view sticks to the top of the header view when it bounces
     */
    GStretchyHeaderViewContentAnchorTop = 0,
    /**
     *  The content view sticks to the bottom of the header view when it bounces
     */
    GStretchyHeaderViewContentAnchorBottom = 1
};

/**
 *  Specifies wether how the stretchy header view will be expanded
 */
typedef NS_ENUM(NSUInteger, GStretchyHeaderViewExpansionMode) {
    /**
     *  The header view will expand only at the top of the scroll view
     */
    GStretchyHeaderViewExpansionModeTopOnly = 0,
    /**
     *  The header view will expand as soon as the user scrolls down
     */
    GStretchyHeaderViewExpansionModeImmediate = 1
};

@interface GStretchyHeaderView : UIView

@property(nonatomic) GStretchyHeaderViewExpansionMode expansionMode;
 ...
 */
@property(nonatomic) GStretchyHeaderViewContentAnchor contentAnchor;
 ...
 *  Have a look at this issue for more information: https://github.com/gskbyte/GStretchyHeaderView/issues/17
 ...
 *
 * - Please see UIScrollView+GStretchyHeaderView.m for more information.
 * - Have a look at this issue for more information: https://github.com/gskbyte/GStretchyHeaderView/issues/63
...
@protocol GStretchyHeaderViewStretchDelegate <NSObject>
...
@interface GStretchyHeaderView (StretchFactor)
...
@interface GStretchyHeaderView (Layout)
